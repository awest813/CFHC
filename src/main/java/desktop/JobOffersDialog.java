...
public class JobOffersDialog extends JDialog {
    ...
    private void buildNoCareerPanel() {
        ...
        JButton ok = createGlassButton("RETURN TO HUB", DesktopTheme.accentBlue());
    ...
    private void buildNoOffersPanel() {
        ...
        JButton ok = createGlassButton("ACKNOWLEDGE", DesktopTheme.accentBlue());
    ...
    private void buildOffersPanel(ArrayList<Team> vacancies) {
        ...
        detailPanel.setBackground(DesktopTheme.dialogSurface());
        ...
        detail.setBackground(DesktopTheme.dialogBackground());
        ...
        detailScroll.setBorder(BorderFactory.createLineBorder(DesktopTheme.dialogDivider(10)));
        ...
        tableScroll.getViewport().setBackground(DesktopTheme.dialogBackground());
        ...
        JButton declineBtn = createGlassButton(isPromotion ? "DECLINE ALL OFFERS" : "DECLINE OPPORTUNITY", DesktopTheme.dangerRed());
        declineBtn.addActionListener(e -> {
            if (isPromotion) userHC.promotionCandidate = false;
            dispose();
        });

        JButton acceptBtn = createGlassButton("ACCEPT CONTRACT", DesktopTheme.successGreen());
