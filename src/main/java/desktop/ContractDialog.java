...
public class ContractDialog extends JDialog {
    ...
    private void buildRetirementPanel(HeadCoach hc) {
        ...
        String statsHtml = String.format(Locale.ROOT,
            ...
            "</table>" +
            "</body></html>",
            hc.name.toUpperCase(Locale.ROOT), hc.age, hc.stats[0], hc.stats[1], hc.stats[6], hc.stats[2], hc.stats[4], hc.getWinPCT() * 100
        );
    ...
    private void buildContractPanel(Team userTeam, HeadCoach hc) {
        ...
        String contractHtml = (userTeam != null) ? userTeam.getContractString().toUpperCase(Locale.ROOT).replace("\n", "<br/>") : "NO ACTIVE CONTRACT DATA.";
        ...
        if (hc != null) {
            String profileHtml = String.format(Locale.ROOT,
                ...
                "WIN RATE: %.1f%%" +
                "</body></html>",
                hc.name.toUpperCase(Locale.ROOT), hc.age, hc.ratOvr, hc.coachStatus().toUpperCase(Locale.ROOT), hc.getSeasonGrade(),
